...
# Load metadata
meta = json.loads(Path('db/metadata.json').read_text(encoding='utf-8'))

# Get T1 data
t1 = meta['tutorial_1']
topics = t1.get('topics', [])
tutorial_label = t1.get('display_name', 'Tutorial 1')
topic_context = t1.get('topic_context', '')[:600] + '...'
...
print("=" * 90)
print("EXACT SYSTEM PROMPT SENT TO LLM (Tutorial 1 example)")
print("=" * 90)
print(sys_msg)
print("\n" + "=" * 90)
